...
bool AppInit(int argc, char* argv[])
{
    ...
    try {
        ...
        if (fCommandLine) {
            fprintf(stderr, "Error: There is no RPC client functionality in nakedcashd anymore. Use the nakedcash-cli utility instead.\n");
            exit(1);
        }
#ifndef WIN32
...
int main(int argc, char* argv[])
{
    ...
    // Connect nakedcashd signal handlers
    noui_connect();
