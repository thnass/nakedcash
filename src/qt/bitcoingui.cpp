                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("nakedcash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a nakedcash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nakedcash: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zNAKD"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About nakedcash Core"), this);
    aboutAction->setStatusTip(tr("Show information about nakedcash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for nakedcash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your nakedcash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified nakedcash addresses"));
    ...
    openInfoAction->setStatusTip(tr("Show diagnakedcashtic information"));
    ...
    openAction->setStatusTip(tr("Open a nakedcash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the nakedcash Core help message to get a list with possible nakedcash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("nakedcash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to nakedcash network", "", count));
}
...
{
    QString strTitle = tr("nakedcash Core"); // default title
