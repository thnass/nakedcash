...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("nakedcash Core"),
     ...
     * override -datadir in the nakedcash.conf file in the default data directory
     * (to be consistent with nakedcashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
