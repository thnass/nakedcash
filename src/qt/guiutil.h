...
/** Utility functions used by the Nakedcash Qt UI.
 */
namespace GUIUtil
{
...
// Render Nakedcash addresses in moNakedcashpace font
...
// Parse "Nakedcash:" URI into recipient object, return true on successful parsing
