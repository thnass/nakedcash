                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received nakedcash from znakedcash"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in znakedcash"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_znakedcash));
