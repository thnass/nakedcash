...
public:
    ...
    void setZnakedcashControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzNAKD_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzNAKD_clicked();
    void on_pushButtonZnakedcashControl_clicked();
