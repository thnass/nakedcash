...
In order to support loading of multiple wallets in nakedcash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nakedcash.cpp.
...
Changes to nakedcash.cpp
----------------------
nakedcash.cpp is the entry point into nakedcash-qt, and as such, will require some minor modifications to provide hooks for
