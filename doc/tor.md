...
```
./nakedcashd -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=dnetzj6l4cvo2fxy.onion:888
```
...
HiddenServicePort 989 127.0.0.1:7291
...
```
./nakedcashd -proxy=127.0.0.1:9050 -externalip=dnetzj6l4cvo2fxy.onion:888 -listen
```
...
and open port 7291 on your firewall (or use -upnp).
