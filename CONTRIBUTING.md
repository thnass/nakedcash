Contributing to Nakedcash Core
============================

The Nakedcash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Nakedcash Core project, and is not to be
confused with overall Nakedcash Network Protocol consensus changes.

Whether a pull request is merged into Nakedcash Core rests with the project merge
...
Patches that change Nakedcash consensus rules are considerably more involved than
...
Where a patch set proposes to change the Nakedcash consensus, it must have been
...
The project leader is the release manager for each Nakedcash Core release.
